...
class Student extends Name{
    studentId:number;
    // name:string;
    studentCourseEnroll:string;
    readonly studentDateofbirth:number;

    constructor(name:string, _dateOfBirth:number, course:string, Id:number){
        super(name)
        console.log(name, course, Id)
        this.studentId=Id
        this.name=name
        this.studentCourseEnroll=course

    }
}

let student1= new Student("hifza", 2004,"typescript",101)
let student2= new Student("Hareem", 2005,"typescript",102)
let student3= new Student("Mehreen",2006,"typescript",103)
...
class Teacher extends Name{
    ...
    subject:string;
    salary:number;
    constructor(name:string, age:number,subject:string,salary:number){
        super(name)
        this.name= name
        this.age=age
...
let teacher1= new Student("hifza", 24,"typescript",15000)
let teacher2= new Student("Hareem", 27,"javascript",20000)
let teacher3= new Student("haleema",22,"python",25000)

console.log(teacher1)
// console.log(teacher2)
// console.log(teacher3)

let nameboth = new Name("hif")
